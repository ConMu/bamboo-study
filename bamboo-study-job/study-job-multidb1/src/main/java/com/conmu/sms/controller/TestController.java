...
public class TestController {
    ...
    @ApiOperation(value = "创建用户", notes = "在数据源1中创建用户信息")
    @ApiResponses({
    ...
    @ApiOperation(value = "根据用户名查询用户", notes = "从数据源1查询用户信息")
    ...
    @ApiOperation(value = "创建人员", notes = "在数据源2中创建人员信息")
    @ApiResponses({
        @ApiResponse(code = 200, message = "创建成功"),
        @ApiResponse(code = 500, message = "创建失败")
    })
    ...
    @ApiOperation(value = "根据姓名查询人员", notes = "从数据源2查询人员信息")
    ...
    @ApiOperation(value = "根据ID查询人员", notes = "从数据源2根据ID查询人员信息")
